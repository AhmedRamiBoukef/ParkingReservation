...
fun GetMain(
    ...
    NavHost(navController = navController, startDestination = Destination.Reservation.route ) {
        ...
        composable(Destination.ReservationDetails.route) { ReservationDetails(navController,getReservationsModel,applicationContext,cancelReservationModel,reservationId = 31 )}
